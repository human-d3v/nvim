...
vim.api.nvim_create_autocmd("LspAttach", {
	callback = function (args)
		...
		vim.keymap.set('n','[d',function() vim.diagnostic.goto_next({severity = {min = vim.diagnostic.severity.HINT}}) end, opts)
		vim.keymap.set('n',']d',function() vim.diagnostic.goto_prev({severity = {min = vim.diagnostic.severity.HINT}}) end, opts)
